...
public class JOCLDeviceQuery
{
	...
	public static void main(String args[])
	{
		...
		for (cl_device_id device : devices)
		{
			...
			int maxComputeUnits = getInt(	device,
																		CL_DEVICE_MAX_COMPUTE_UNITS);
			...
			long maxMemAllocSize = getLong(	device,
																			CL_DEVICE_MAX_MEM_ALLOC_SIZE);
			...
			int maxReadImageArgs = getInt(device,
																		CL_DEVICE_MAX_READ_IMAGE_ARGS);
			...
			long image3dMaxWidth = getSize(	device,
																			CL_DEVICE_IMAGE3D_MAX_WIDTH);
			...
			long image3dMaxDepth = getSize(	device,
																			CL_DEVICE_IMAGE3D_MAX_DEPTH);
	 ...
	 * @return The value
	 */
	private static int[] getInts(	cl_device_id device,
																int paramName,
																int numValues)
	{
	 ...
	 * @return The value
	 */
	private static long[] getLongs(	cl_device_id device,
																	int paramName,
																	int numValues)
	{
	 ...
	 * @return The value
	 */
	private static String getString(cl_platform_id platform,
																	int paramName)
	{
		// Obtain the length of the string that will be queried
		long size[] = new long[1];
	 ...
	 * @return The value
	 */
	static long[] getSizes(	cl_device_id device,
													int paramName,
													int numValues)
	{
