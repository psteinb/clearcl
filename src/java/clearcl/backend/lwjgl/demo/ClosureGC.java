...
public class ClosureGC implements ClosureRegistry
{
  ...
  /**
   * Releases all Closures that were allocated at the current stack depth and
   * restores the previously pushed level.
   */
  public void pop()
  {
    stacks.get().pop();
  ...
  private static class Stack
  {
    ...
    private static final int INIT_DEPTH = 4, INIT_SIZE = 8;
