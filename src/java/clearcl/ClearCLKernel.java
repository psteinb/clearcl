...
public class ClearCLKernel extends ClearCLBase implements Runnable
{
	...
	public ConcurrentHashMap<String, Number> getKernelDefaultArgumentsMap(final String pKernelName)
	{
																								...
																								lBeginOfDefault)) != -1)
		{
			...
			final String lArgumentName = lTwoPointsAndEqualSplit[2]	.trim()
																															.toLowerCase();
			String lArgumentValue =
														lTwoPointsAndEqualSplit[3].trim()
																											.toLowerCase();

			final char lArgumentType = lArgumentValue.charAt(lArgumentValue.length()
																												- 1);
	...
	public ConcurrentHashMap<String, Integer> getKernelIndexMap(final String pKernelName)
	{
	...
	public String[] getKernelSignature(final String pKernelName)
	{
		final String lSourceCode = getSourceCode();
		{
			...
			if (lBeginOfKernelSignature >= 0)
			{
				...
				final String lSubStringSignature = lSubStringKernel.substring(lSubStringKernel.indexOf('(')
																																				+ 1,
