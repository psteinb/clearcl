...
public class ClearCLBasicTests
{
	...
	{
		final ClearCLBackendJavaCL lClearCLBackendJavaCL = new ClearCLBackendJavaCL();
													...
													final ClearCLProgram pProgram)
	{
		...
		final ClearCLImage lImageSrc = lContext.createImage(HostAccessType.WriteOnly,
														...
														final ClearCLProgram pProgram) throws IOException
	{
		...
		final ClearCLBuffer lBufferA = lCreateContext.createBuffer(	HostAccessType.WriteOnly,
																																KernelAccessType.ReadOnly,
																																NativeTypeEnum.Float,
																																cFloatArrayLength);

		final ClearCLBuffer lBufferB = lCreateContext.createBuffer(	HostAccessType.WriteOnly,
																																KernelAccessType.ReadOnly,
																																NativeTypeEnum.Float,
																																cFloatArrayLength);

		final ClearCLBuffer lBufferC = lCreateContext.createBuffer(	HostAccessType.ReadOnly,
																																KernelAccessType.WriteOnly,
																																NativeTypeEnum.Float,
																																cFloatArrayLength);
